            ...
            <div class="nav_bar">
                <ul class="menuN">
                    <li class="menu_header">
                        <img src="<%=basePath%>/static/image/logo.png" alt="logo.png"/>
                        <h3>平台管理系统</h3>
                    </li>
...
function skipEnter(enterurl){
	document.getElementById("frame").src="<%=basePath%>"+enterurl;
}

//账户信息
function accEditing(){
  	window.parent.skipEnter("/settings/informationsize?");
}
...
// }
function pwdModify(){
	window.parent.skipEnter("/settings/updatePassPage")
}
