...
public final class DateTools {
	...
	public static long getDays(String b1, String e1, String b2, String e2) {
		...
		try {
			...
			// 时间段不相交
			if ((begin2.getTime().getTime() > end1.getTime().getTime() && end2.getTime().getTime() > end1.getTime().getTime()) || (begin2.getTime().getTime() < begin1.getTime().getTime() && end2.getTime().getTime() < begin1.getTime().getTime())) {
