...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="<%=basePath%>/static/js/ueditor/addCustomizeUploadImage.js"></script>
    <script type="text/javascript" charset="utf-8" src="<%=basePath%>/static/js/ueditor/addCustomizeUploadVideo.js"></script>
